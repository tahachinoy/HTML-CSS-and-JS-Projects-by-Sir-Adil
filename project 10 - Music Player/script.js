...
function loadTrack(track) {
    // Update the text for the title of the track 
    title.innerText = track;
    // Update the src in the audio element with the audio file of the track
    audio.src = `music/${track}.mp3`;
    // Update the src in the img element with the image file of the track
...
function updateProgress(e) {
    ...
    // Reassign width of progressbar using the progress percentage
...
function setProgress(e) {
    ...
    // Get the x axis px value for the location of click on the progress bar
    const clickLocation = e.offsetX;
    // Get the total duration of the track
    const duration = audio.duration;
    // Reassign the current time of audio track by calculating based on above metrics
