...
function searchMeal(e) {
    ...
    //Cehck if search input field is empty
    if (searchText.trim()) {
        //Fetch data from api 
        fetch(`https://www.themealdb.com/api/json/v1/1/search.php?s=${searchText}`)
            ...
            .then(data => {
                ...
                //Check if any meals returned from the API
                if (data.meals === null) {
...
function displayMealDetails(meal) {
    ...
    for (let i = 1; i <= 20; i++) {
        ...
        if (meal[`strIngredient${i}`]) {
            ...
            // Push all the ingredients and measurement in to  ingredients array
...
function generateRandomMeal(meal) {
